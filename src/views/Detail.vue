        ...
        <div>
          <div>
            <v-card flat color="transparent">
              ...
              <v-card-text>
                <div>
                  <v-btn color="accent">Dream booth</v-btn>
                </div>

                <div class="text-h4 font-weight-bold primary--text pt-4">
                  <h4>15 Things | have always wondered about AI</h4>
                </div>
                ...
                <div class="d-flex align-center justify-space-between">
                  <div class="d-flex align-center">
                    ...
                    <div class="pl-2 text-body-1">Yiming huang · 23 March 2023</div>
                  </div>
                ...
                <div class="my-8">
                  <div class="d-flex align-center">
                    ...
                    <div class="pl-4">
                      <div class="text-h5 primary--text font-weight-bold">
                        Written by
                        <span class="accent--text">Tim</span>
                      </div>
