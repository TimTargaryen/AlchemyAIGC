    ...
    <v-row>
      <v-col cols="12" lg="12" xl="8">
        <div>
          <div>
            <div class="my-2">
              <h2 class="text-h4 font-weight-bold">Brilliant Works!</h2>
            </div>
                    ...
                    >
                      ...
                      <v-card-text class="text-center">
                        ...
                        <div class="text-body-1 py-4">
                          Live or Death? Maybe it's a profound question over human beings in this world.
                        </div>
